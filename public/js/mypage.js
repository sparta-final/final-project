  ...
  axios
    ...
    .then((res) => {
      ...
      if (data.membership === null) {
        ...
        <div class="member-paid-list" onclick="location.href='mypage/paymentDetails'" >결제 내역 <img src="//www.sixpack.pro/images/right-arrow.png" alt="" class="member-info-btn"  /></div>
        <div class="use-gym-list" onclick="location.href='mypage/history'">헬스장 이용 내역 <img src="//www.sixpack.pro/images/right-arrow.png" alt="" class="member-info-btn" /></div>
        <div class="my-review" onclick="location.href='/mypage/review'" >리뷰 관리 <img src="//www.sixpack.pro/images/right-arrow.png" alt="" class="member-info-btn" /></div>
        </div>
        `;
      } else {
        temp = `
